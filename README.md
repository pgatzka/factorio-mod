...
- Roboports clear that debris on their own: each marks the closest piece for deconstruction and waits until no debris in its range is marked before marking the next one.
